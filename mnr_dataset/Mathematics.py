...
class MAttribute(object):
    ...
    # Placeholder for the sample method (To be overridden by subclasses) 
    def sample(self):
        pass
...
class Integer(MAttribute):
    ...
    def __init__(self, n_sample=NUM_CORRECT_PANELS, min_level=INTEGER_MIN, max_level=INTEGER_MAX):
        self.value_level = []
    ...
    def sample(self, n_sample=NUM_CORRECT_PANELS, min_level=INTEGER_MIN, max_level=INTEGER_MAX):
        self.value_level = []
