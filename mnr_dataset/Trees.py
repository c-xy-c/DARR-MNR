...
def prune_problem_tree(root, gcondition_1, gcondition_2, interpret, analytical_part):
    new_root = copy.deepcopy(root) # Deep copy generates a new and independent copy of the entire object
    ...
    # print("In Tree.py, prune_problem_tree func, gcondition_1: ", gcondition_1)
